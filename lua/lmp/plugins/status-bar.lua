-- just don't use galaxyline yet...it's very pretty but fucky
return {
	{
	...
	},
	{
		...
		opts = function()
			...
			vim.api.nvim_set_hl(0, "NavicIconsFile", { default = true, bg = "#F88195", fg = "#ffffff" })
			...
			vim.api.nvim_set_hl(0, "NavicSeparator", { default = true, bg = "#F67280", fg = "#ffffff" })
